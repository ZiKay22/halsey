...
<div class="col-12 col-md-6 col-lg-4 my-3">
    ...
    <div class="card">
        ...
        <div class="card-body bg-dark text-light">
          ...
          <a href="room93.php" class="btn btn-primary">Go To See</a>
...
<div class="col-12  col-md-6 col-lg-4 my-3">
    <div class="card">
        ...
        <div class="card-body bg-dark text-light">
          ...
          <a href="badlands.php" class="btn btn-primary">Go To See</a>
        </div>
      </div>
</div>
<div class="col-12 col-md-6 col-lg-4 my-3">
    <div class="card">
        ...
        <div class="card-body bg-dark text-light">
          ...
          <a href="Hopeless Fountain Kingdom.php" class="btn btn-primary">Go To See</a>
        </div>
      </div>
</div>
            ...
            <div class="col-12 col-md-6 col-lg-4 my-3">
                <div class="card">
                    ...
                    <div class="card-body bg-dark text-light">
                      ...
                      <a href="manic.php" class="btn btn-primary my-1">Go To See</a>
            ...
            <div class="col-12 col-md-6 col-lg-4 my-3">
                <div class="card">
                    ...
                    <div class="card-body bg-dark text-light">
                      ...
                      <a href="iichliwp.php" class="btn btn-primary">Go To See</a>
